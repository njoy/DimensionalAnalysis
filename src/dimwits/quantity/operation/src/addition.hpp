...
//     /* in addition operation, the unit defaults to that of the left argument */
//     auto /* m */ length2 = length0 /* m */ + length1 /* cm */;
//     REQUIRE( length2.value == doctest::Approx(1.01) );
    
//     auto /* cm */ length3 = length1 /* cm */ + length0 /* m */ ;
//     REQUIRE( length3.value == doctest::Approx(101.) );

//     /* of course, the default can be overrided by specifying a unit */
//     quantity::Type< Centi<Meter> > length4 = length0 + length1;
//     REQUIRE( length4.value == doctest::Approx(101.) );

//     quantity::Type< Meter > length5 = length1 + length0;
//     REQUIRE( length5.value == doctest::Approx(1.01) );
//   }
// }
